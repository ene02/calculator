...
namespace Calculator.Tests
{
    ...
    public class CalculatorTests
    {
        ...
        public void IsSyntaxCorrectTrueTest()
        {
            ...
            string correctSyntaxUnhinged = "((15+25)-(35*45)^3/(55^2+(3#60))#15+(20/5)^2*4#16)-(100#2+(30^3-(45#3)))^2/((7*9)+5^2*3)-(((6#36)+((8^3-2)^4#81)/(11+22))-((10^3-3)+(8^3-4)))/(18#81-((9#27)^2/3)+5^3)";
            ...
            Assert.IsTrue(Calculator.IsSyntaxCorrect(correctSyntaxUnhinged));
        }
